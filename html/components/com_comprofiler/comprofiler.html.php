...
<div class="cbEditProfile"><div id="cbEditProfileInner" class="cbHtmlEdit">
	...
	if ( $regErrorMSG ) {
		...
		echo "<dl id='system-message'><dd class='error'><ul><li>".$regErrorMSG."</li></ul></dt></dl>\n";
	}
...
<?php
	...
	static function loginForm( $option, &$postvars, $regErrorMSG = null ) {
		...
		echo '<div class="cbclearboth"><div id="cb_cb_comp_login"><div class="cb_comp_outer"><div class="cb_comp_inner">';
		echo $moduleContent;
