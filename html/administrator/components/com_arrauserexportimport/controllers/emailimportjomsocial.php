 ...
 *
 * file: emailimportjomsocial.php
 *
 **** class 
     ArrausersexportimportControllerEmailimportjomsocial
 ...
 */
class ArrausersexportimportControllerEmailimportjomsocial extends ArrausersexportimportController{
    var $_model = null;
	/**
	...
	function __construct() {   
	    ...
	    $this->registerTask( 'email_import', 'emailImport' );
	}
	
	function emailImport(){
		JRequest::setVar( 'view', 'emailimportjomsocial' );
