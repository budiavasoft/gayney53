 ...
 *
 * file: jomsocialemailexport.php
 *
 **** class 
     ArrausersexportimportControllerJomsocialemailexport
 ...
 */
class ArrausersexportimportControllerJomsocialemailexport extends ArrausersexportimportController{
    var $_model = null;
	/**
	...
	function emailExport(){
		JRequest::setVar( 'view', 'jomsocialemailexport' );
