...
defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	$document->addStyleSheet("components/com_arrauserexportimport/css/arra_edit_user.css");
...
<form action="index.php" method="post" name="adminForm" autocomplete="off">
	<table width="100%">
		<tr>
			<td style="color:#0B55C4; font-size:22px; font-weight:bold; line-height:48px; margin-left:50px; padding-left:5px; ">
				<?php echo JText::_('User') . ': <small><small>[ '. $text .' ]</small></small>'; ?>
			</td>
			<td align="right">
				<?php if($cid["0"] != "0"){ ?>
				<input type="button" class="savebutton" value="" onclick="javascript:submitbutton('save');"/>
				<input type="button" class="cancelbutton" value="" onclick="javascript:submitbutton('cancel');"/> 
				<?php } ?>
			</td>
		</tr>
	</table>
	...
	<input type="hidden" name="controller" value="userdetails" />
