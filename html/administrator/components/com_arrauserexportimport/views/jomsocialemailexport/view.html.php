 ...
 *
 **** class 
     ArrausersexportimportViewJomsocialemailexport
 ...
 *
 */
class ArrausersexportimportViewJomsocialemailexport extends JView{
	/**
	 * display method 
	 * @return void
	 **/
	...
	function custom_email(){
		...
		$emailSettings .=           "<input type=\"button\" name=\"save_email_export\" value=\"".JText::_("ARRA_SAVE_EMAIL_EXPORT_BUTTON")."\" onClick=\"javascript:saveJomsocialEmailExport();\">";
		$emailSettings .=        "</td>";
		$emailSettings .=     "</tr>";
		$emailSettings .=     "<tr>";
