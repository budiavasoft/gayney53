...
defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	$document->addScript(JURI::base()."components/com_arrauserexportimport/includes/js/utf.js");
...
<form action="index.php" method="post" name="adminForm1" id="adminForm1"> 
    <table>
	     <tr>
		 	<td valign="top">
				<textarea name="export_result" id="export_result" cols="90" rows="32" wrap="off"><?php if(isset($this->export_result)){ echo $this->export_result;} ?></textarea>
			</td>
		    <td valign="top">
			   <table  width="100%">
			   	<tr>		 		 
...
<?php
	echo $tabs->endPanel();
	echo $tabs->startPanel(JText::_("ARRA_UTF_IMPORT_PANEL"), 'export' ) ;
?>
	   ...
	   <tr width="100%">
	      <td valign="top">
			  <table width="100%">
				  ...
				  <tr>
				  	<td>
				  		<textarea name="file_content" id="file_content" cols="105" rows="26" wrap="off"></textarea>
					</td>	
				  </tr>				  				 
			  </table>
	      </td>
