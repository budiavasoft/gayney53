 ...
 *
 **** class 
     ArrausersexportimportViewImport 
 ...
 *
 */
class ArrausersexportimportViewImport extends JView{
	/**
	 * display method 
	 * @return void
	 **/
	...
	function uploadSqlZipFile(){
		...
		$upload_file .=                 "<span>" . JText::_("ARRA_NOTE_SQL_EXPORT"). " ".$prefix."core_acl_aro_groups, ".$prefix."users, ".$prefix."core_acl_aro, ".$prefix."core_acl_groups_aro_map"."<br/><br/>".JText::_("ARRA_NOTE_SQL_EXPORT_BACK_UP")."</span>";
		$upload_file .= 			"</td>";
		$upload_file .= 		"</tr>";
		$upload_file .= 		"<tr>";
		$upload_file .= 			"<td>";
